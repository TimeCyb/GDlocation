...
// 首页
import TolietPage from './src/tolietPage';
// 阅读
...
const dataSource = [
  {
    icon:img1_base64,
    selectedIcon:img1_base64,
    tabPage:'卫生间',
    tabName:'卫生间',
    component:TolietPage
  },
  {
    icon:img2_base64,
    selectedIcon:img2_base64,
    tabPage:'阅读',
    tabName:'阅读',
    component:Read
  },
